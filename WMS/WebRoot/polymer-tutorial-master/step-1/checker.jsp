                ...
                <ul class="nav nav-pills">
                    ...
                    <li class="dropdown dropdown-big">
                        <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                            <i class="icon-envelope-alt"></i> Inbox <span class="label label-primary"><% %></span>
                        </a>
...
<div class="content">
    ...
    <div class="sidebar">
        ...
        <ul id="nav">
            ...
            <li><a href="index.html" class="open"><i class="icon-home"></i> Home</a>
                <!-- Sub menu markup
                <ul>
            ...
            <li><a href="check_in.jsp" id="check"><i class="icon-bar-chart"></i> Check in</a></li>
