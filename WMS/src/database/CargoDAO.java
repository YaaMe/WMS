...
public class CargoDAO extends BaseHibernateDAO {
	...
	// property constants
	public static final String CARGO_ORIGIN = "cargoOrigin";
	public static final String CARGO_DESTINATION = "cargoDestination";
	...
	public Cargo findById(java.lang.String id) {
		...
		try {
			Cargo instance = (Cargo) getSession().get("database.Cargo", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Cargo instance) {
		...
		try {
			List results = getSession().createCriteria("database.Cargo").add(
	...
	public List findByCargoOrigin(Object cargoOrigin) {
		return findByProperty(CARGO_ORIGIN, cargoOrigin);
	}

	public List findByCargoDestination(Object cargoDestination) {
		return findByProperty(CARGO_DESTINATION, cargoDestination);
	}
